...
parser.add_argument('--gpus', type=str, default='0', help="gpu choose, eg. '0,1,2,3' ")
...
def main(args):
    ...
    # if more than 1 gpu found, we use DP to train the model, the first gpu serves as main worker
    if args.nprocs > 1:
